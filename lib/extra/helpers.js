...
import SkyboxMaterial from'../material/skybox';
...
export function skybox(...urls): Model {
    const materialPromise = CubeMap.fromFiles(...urls).then(cubemap => new SkyboxMaterial(cubemap));

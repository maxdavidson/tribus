export default class GLBuffer {
    ...
    constructor(gl, data, vao, { mode = gl.STATIC_DRAW, size = 3, bufferType = gl.ARRAY_BUFFER, dataType = gl.FLOAT } = {}) {
    ...
    bind() {
        const needsAttribues = this.data && this.data.length !== 0 && this.bufferType !== this.gl.ELEMENT_ARRAY_BUFFER;
     ...
     */
    setAttribLocation(location, program) {
